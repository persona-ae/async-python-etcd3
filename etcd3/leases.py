...
class AioLease(Lease):
    ...
    def remaining_ttl(self):
        raise NotImplementedError(
            "Use the corountine method AioLease.get_remaining_ttl() instead.")

    @property
    def granted_ttl(self):
        raise NotImplementedError(
            "Use the corountine method AioLease.get_granted_ttl() instead.")

    @property
    def keys(self):
        raise NotImplementedError(
            "Use the corountine method AioLease.get_keys() instead.")
